...
//! `IndexStore` owns lazy read-only access to this module's unlimited neighborhood
//! query. Extraction, indexing writes and relationship pipelines follow separately.
